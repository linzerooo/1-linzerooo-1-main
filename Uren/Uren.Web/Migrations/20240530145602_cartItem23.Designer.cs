...
using DbContext = Finate.Persistence.DbContext;
...
namespace Finate.Web.Migrations
{
    ...
    [Migration("20240530145602_cartItem23")]
    partial class cartItem23
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finate.Application.Interfaces.ProductCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<List<string>>("ImageSrc")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Finate.Domain.Entities.CandidateFormExtension", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CandidateFormExtensions");
                });

            modelBuilder.Entity("Finate.Domain.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Finate.Domain.Entities.Form", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Finate.Domain.Entities.JobFormExtension", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FormSkill", b =>
                {
            ...
            modelBuilder.Entity("FormUserLanguage", b =>
                {
                    b.Property<Guid>("FormsId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("FormsId", "LanguagesId");

                    b.HasIndex("LanguagesId");

                    b.ToTable("FormUserLanguage");
                });
            ...
            modelBuilder.Entity("Finate.Domain.Entities.CandidateFormExtension", b =>
                {
                    b.HasOne("Finate.Domain.Entities.Form", "CandidateForm")
                        .WithMany()
            ...
            modelBuilder.Entity("Finate.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("Finate.Application.Interfaces.ProductCard", "ProductCard")
                        .WithMany()
            ...
            modelBuilder.Entity("Finate.Domain.Entities.Experience", b =>
                {
                    b.HasOne("Finate.Domain.Entities.CandidateFormExtension", "CandidateFormExtension")
                        .WithMany("Experiences")
                        .HasForeignKey("CandidateFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CandidateFormExtension");
                });
            ...
            modelBuilder.Entity("Finate.Domain.Entities.JobFormDescriptionPart", b =>
                {
                    b.HasOne("Finate.Domain.Entities.JobFormExtension", "JobForm")
            ...
            modelBuilder.Entity("Finate.Domain.Entities.JobFormExtension", b =>
                {
                    b.HasOne("Finate.Domain.Entities.Form", "JobForm")
                        .WithMany()
            ...
            modelBuilder.Entity("FormSkill", b =>
                {
                    b.HasOne("Finate.Domain.Entities.Form", null)
                        .WithMany()
                        .HasForeignKey("FormsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Finate.Domain.Entities.Skill", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FormTag", b =>
                {
                    ...
                    b.HasOne("Finate.Domain.Entities.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FormUserLanguage", b =>
                {
                    ...
                    b.HasOne("Finate.Domain.Entities.UserLanguage", null)
                        .WithMany()
